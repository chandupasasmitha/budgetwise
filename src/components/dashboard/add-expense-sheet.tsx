    ...
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      ...
      <SheetContent>
        <SheetHeader>
          ...
          <SheetDescription>
            Fill in the details of your expense below. Click save when you&apos;re done.
          </SheetDescription>
        </SheetHeader>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 py-4">
            ...
            />
             <Button type="button" size="sm" variant="outline" onClick={handleSuggestCategory} disabled={isSuggesting}>
